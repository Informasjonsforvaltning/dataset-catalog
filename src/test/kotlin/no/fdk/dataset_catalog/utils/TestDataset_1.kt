...
val TEST_DATASET_1 = Dataset(
    ...
    conformsTo = listOf(CONFORMS_TO),
    hasCurrentnessAnnotation=(QualityAnnotation(hasBody = mapOf(Pair("no", "Denne teksten sier noe om aktualiteten. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mattis consectetur purus sit amet fermentum. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.")))),
    hasRelevanceAnnotation=(QualityAnnotation(hasBody = mapOf(Pair("no", "Denne teksten sier noe om relevansen. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mattis consectetur purus sit amet fermentum. Cum sociis natoque penatibus et magnis dis parturient montes.")))),
    hasCompletenessAnnotation=(QualityAnnotation(hasBody = mapOf(Pair("no", "Denne teksten sier noe om komplettheten. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mattis consectetur purus sit amet fermentum.")))),
    hasAccuracyAnnotation=(QualityAnnotation(hasBody = mapOf(Pair("no", "Denne teksten sier noe om nøyaktigheten. Cras mattis consectetur purus sit.")))),
    hasAvailabilityAnnotation=(QualityAnnotation(hasBody = mapOf(Pair("no", "Denne teksten sier noe om tilgjengeligheten. Vestibulum id ligula porta felis euismod semper. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum.")))),
    language=listOf(
