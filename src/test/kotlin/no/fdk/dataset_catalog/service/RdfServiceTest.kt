    ...
    internal inner class Serialize {
        ...
        fun `Serializes dataset relations`() {
            val dataset = DatasetDBO(
                catalogId = "http://catalog/1",
                published = true,
                id = "http://catalog/1/dataset/1",
                uri = "http://catalog/1/dataset/1",
                relatedResources = listOf(
                    UriWithLabel(
                        uri = "http://uri-1", prefLabel = LocalizedStrings(nb = "label-1-nb", en = "label-1-en")
                    ),
                    UriWithLabel(
                        uri = "http://uri-2",
            ...
            whenever(datasetService.getAllDatasets("http://catalog/1")).thenReturn(listOf(dataset))
